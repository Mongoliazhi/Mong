<template>
  <div id="play" class="music-play-page">
    <!--<audio-->
           <!--src="http://mp3.9ku.com/m4a/183203.m4a"-->
           <!--autoplay></audio>-->
    <audio id="music"
           src="http://ws.stream.qqmusic.qq.com/C100003mAan70zUy5O.m4a?fromtag=46"
           autoplay></audio>
    ...
    <div class="button-group">
      ...
      <div class="music-info">
        <p class="music-name">333</p>
        <p class="music-author">444</p>
      </div>
      <!--<div class="lyric">-->
      ...
      <div class="music-ctrl">
        <ul>
          <li><img src="../../../static/images/shuijiao.jpg"></li>
          <li><img src="../../../static/images/shuijiao.jpg"
                   ></li>
          <li><img src="../../../static/images/shuijiao.jpg"
                 ></li>
          <li><img src="../../../static/images/shuijiao.jpg"
